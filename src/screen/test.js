...
import { Text, Button, StyleSheet, ScrollView, View, Dimensions, TextInput } from 'react-native';
		...
		return (
			<View style={styles.wrapper}>
				...
				>
					...
					<Button
						title={`Disable swipeToClose(${this.state.swipeToClose ? 'true' : 'false'})`}
				...
				<Modal style={[ styles.modal, styles.modal4 ]} position={'bottom'} ref={'modal6'} swipeArea={20}>
					<ScrollView>
						<View style={{ width: screen.width, paddingLeft: 10 }}>{this.renderList()}</View>
					</ScrollView>
				</Modal>
