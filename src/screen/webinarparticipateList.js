...
const iconname_ = 'user';

class webinarparticipateList extends Component {
	constructor(props) {
		super(props);
		(this.page = 1),
			(this.state = {
	...
	async componentDidMount() {
		...
		this.loadAPI(this.state.webinarid, 'pull');
...
export default withNavigation(webinarparticipateList);
