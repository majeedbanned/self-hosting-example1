	...
	return (
		<View>
			<ScrollView>
				...
				<Button onPress={() => navigation.navigate('Textscr')} title="go to text screen1f" />

				<Button onPress={() => navigation.navigate('SearchScreen')} title="go to SearchScreen" />
				...
				<Button
					onPress={() => navigation.navigate('reactnativesnapcarousel')}
					title="reactnativesnapcarousel"
				/>
